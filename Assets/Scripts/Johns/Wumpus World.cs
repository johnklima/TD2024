...
public class WumpusWorld : MonoBehaviour
{
    ...
    void StartGame()
    {
        ...
        //Activate player
        objs[0, 0].GetComponent<WumpusData>().Activate(true);
        ...
        if (true)
        {
            for (int row = 0; row < ROWS; row++)
            {
                ...
                {
                    objs[row, col].GetComponent<WumpusData>().Activate(true);
    ...
    //this builds the main wumpus grid
    public void Build()
    {
        for (int row = 0; row < ROWS; row++)
        {
            for (int col = 0; col < COLS; col++)
            {
                ...
                //let the cell data know where it is
                data.row = row;
                data.col = col;
